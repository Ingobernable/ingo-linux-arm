...
sleep 3
apt-get update
apt-get install -y gcc-arm-linux-gnueabihf wget tree git debootstrap qemu-user-static build-essential bin86 kernel-package libqt4-dev libncurses5 libncurses5-dev qt4-dev-tools u-boot-tools device-tree-compiler swig libpython-dev libqt4-dev
clear
